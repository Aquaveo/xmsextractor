...
class XmsextractorConan(ConanFile):
    ...
    def build(self):
        ...
        cmake.definitions["IS_PYTHON_BUILD"] = self.options.pybind != "" and self.options.pybind is not None
        ...
        elif self.options.pybind != "" and self.options.pybind is not None:
    ...
    def requirements(self):
        ...
        if self.options.pybind != "" and self.options.pybind is not None:
