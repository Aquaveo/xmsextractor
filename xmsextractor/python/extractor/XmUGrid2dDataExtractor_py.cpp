...
void initXmUGrid2dDataExtractor(py::module &m) {
    py::class_<xms::XmUGrid2dDataExtractor, BSHP<xms::XmUGrid2dDataExtractor>> extractor(m, "UGrid2dDataExtractor");

    // -------------------------------------------------------------------------
    // function: init
    // -------------------------------------------------------------------------
    extractor.def(py::init([](std::shared_ptr<xms::XmUGrid> ugrid) -> BSHP<xms::XmUGrid2dDataExtractor> {
      BSHP<xms::XmUGrid2dDataExtractor> rval(xms::XmUGrid2dDataExtractor::New(ugrid));
